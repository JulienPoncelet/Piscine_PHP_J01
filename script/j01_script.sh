...
diff ./ex03_0_test ./ex03_0_user | cat -e;

echo "\nex00 :\n";
../ex00/hw.php > ex00_0_user;
diff ./ex00_0_test ./ex00_0_user | cat -e;
...
diff ./ex04_0_test ./ex04_0_user | cat -e;
diff ./ex04_1_test ./ex04_1_user | cat -e;
...
diff ./ex05_0_test ./ex05_0_user | cat -e;
diff ./ex05_1_test ./ex05_1_user | cat -e;
diff ./ex05_2_test ./ex05_2_user | cat -e;
...
diff ./ex06_0_test ./ex06_0_user | cat -e;
diff ./ex06_1_test ./ex06_1_user | cat -e;
diff ./ex06_2_test ./ex06_2_user | cat -e;
...
diff ./ex07_0_test ./ex07_0_user | cat -e;
diff ./ex07_1_test ./ex07_1_user | cat -e;
diff ./ex07_2_test ./ex07_2_user | cat -e;

echo "\nex08 :\n"
./ex08_0_test.php > ex08_0_user

diff ./ex08_0_user ./ex08_0_test | cat -e;
...
diff ./ex09_0_user ./ex09_0_test | cat -e;
diff ./ex09_1_user ./ex09_1_test | cat -e;
...
diff ./ex10_0_user ./ex10_0_test | cat -e;
diff ./ex10_1_user ./ex10_1_test | cat -e;
diff ./ex10_2_user ./ex10_2_test | cat -e;
diff ./ex10_3_user ./ex10_3_test | cat -e;
diff ./ex10_4_user ./ex10_4_test | cat -e;
...
diff ./ex11_0_user ./ex11_0_test | cat -e;
diff ./ex11_1_user ./ex11_1_test | cat -e;
diff ./ex11_2_user ./ex11_2_test | cat -e;
diff ./ex11_3_user ./ex11_3_test | cat -e;
diff ./ex11_4_user ./ex11_4_test | cat -e;
diff ./ex11_5_user ./ex11_5_test | cat -e;
